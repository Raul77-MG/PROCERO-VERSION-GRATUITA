...
//Botones de descarga
const descargaCasa = document.getElementById("descargarButton");
const descargaEdificio = document.getElementById("descargarButton2");
...
function actualizarOpciones() {
    ...
    const descargaEdificio = document.getElementById("descargarButton2");
    descargaEdificio.style.display = "none";
...
function mostrarImagen2() {
    ...
    if (imagenSrc2 === "") {
        ...
        const descargaEdificio = document.getElementById("descargarButton2");
        descargaEdificio.style.display = "block";
    }
...
function actualizarOpcionesCasa() {
    const descargaCasa = document.getElementById("descargarButton");
    descargaCasa.style.display = "none";
    ...
    if (selectedAncho=== "9") {
        largoSelect.add(new Option("21 metros", "21"));
...
function mostrarImagen() {
    ...
    if (imagenSrc === "") {
        ...
        const descargaCasa = document.getElementById("descargarButton");
        descargaCasa.style.display = "block";
    }
